package com.wanpiao.master.mvp.ui;
...
public class BannerLayout extends RelativeLayout {
    ...
    //添加网络图片路径
    public void setViewUrls(List<String> urls, List<String> titles, LinearLayout guideLinearLayout) {
        imgs=urls.size();
        List<View> views = new ArrayList<>();
        itemCount = urls.size();
        ...
        setViews(views, guideLinearLayout);
    }

    private void setViews(final List<View> views, LinearLayout guideLinearLayout) {
        ...
        if(guideLinearLayout!=null){
            indicatorContainer = guideLinearLayout;
            indicatorContainer.removeAllViews();
//            ViewGroup parent = (ViewGroup) indicatorContainer.getParent();
//            if (parent != null) {
//                parent.removeView(indicatorContainer);
//            }
