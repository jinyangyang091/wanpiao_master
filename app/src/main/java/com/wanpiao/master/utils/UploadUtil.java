...
public class UploadUtil {
    ...
    //语音文件上传成功
    public static final int UPLOAD_SUCCESS_CODE2 = 16;
    ...
    private void toUploadFile(File file, String fileKey, String RequestURL, Map<String, String> param) {
        ...
        try {
            ...
            Log.d("jinyangyang+","img upload token ======== "+SPUtils.get(App.getInstance(), "token",""));
            conn.setRequestProperty("token", SPUtils.get(App.getInstance(), "token",""));
            ...
            if (res == 200) {
                ...
                try {
                    ...
                    if (userHeaderUrl.contains(".mp3")){
                        sendMessage(UPLOAD_SUCCESS_CODE2, result);
                    }else {
